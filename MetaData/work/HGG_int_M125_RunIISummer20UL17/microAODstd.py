...
process.GlobalTag = GlobalTag(process.GlobalTag,'','')
process.source = cms.Source("PoolSource",
                             fileNames=cms.untracked.vstring("/store/mc/RunIISummer20UL17MiniAOD/GluGluHToGG_int_M125_13TeV-sherpa/MINIAODSIM/106X_mc2017_realistic_v6-v2/250000/0E06BE43-C99A-DD4E-B97F-4042348B4133.root"))
...
process.out = cms.OutputModule("PoolOutputModule", fileName = cms.untracked.string('MicroAOD_HGG_Int_M125_UL2017.root'),
...
#process.flashggPDFWeightObject.Debug = True 
