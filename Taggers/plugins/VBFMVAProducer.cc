    ...
    void VBFMVAProducer::produce( Event &evt, const EventSetup & )
    {
        ...
        for( unsigned int candIndex = 0; candIndex < diPhotons->size() ; candIndex++ ) {
            ...
            if( hasValidVBFDiJet ) {
                ...
                /*
                cout << "dijet_leadEta_ : " << dijet_leadEta_ << " dijet_subleadEta_: " << dijet_subleadEta_ << " dijet_abs_dEta_: " << dijet_abs_dEta_ << " dijet_LeadJPt_: " << dijet_LeadJPt_ << endl;
                cout << "dijet_pt_: " << dijet_pt_ << " dijet_SubJPt_: " << dijet_SubJPt_ << " dijet_dipho_dphi_: " << dijet_dipho_dphi_ << " dijet_dphi_trunc_: " << dijet_dphi_trunc_ << endl;
                cout << "dijet_dphi_: " << dijet_dphi_ << " dijet_dipho_pt_: " << dijet_dipho_pt_ << " dijet_Zep_: " << dijet_Zep_ << " dijet_centrality_gg_: " << dijet_centrality_gg_ << endl;
                cout << "dijet_centrality_g_: " << dijet_centrality_g_ << " dijet_Mjj_: " << dijet_Mjj_ << " dipho_PToM_: " << dipho_PToM_ << " dipho_cosphi_: " << dipho_cosphi_ << endl;
                cout << "dipho_cosphi_: " << dipho_cosphi_ << " dipho_subleadEta_: " << dipho_subleadEta_ << " dipho_sumpt_: " << dipho_sumpt_ << " dipho_leadPt_: " << dipho_leadPt_ << endl;
                cout << "dipho_subleadPt_: " << dipho_subleadPt_ << " dipho_leadPhi_: " << dipho_leadPhi_ << " dipho_subleadPhi_: " << dipho_subleadPhi_ << " leadPho_PToM_: " << leadPho_PToM_ << endl;
                cout << " sublPho_PToM_: " << sublPho_PToM_ << " dijet_minDRJetPho_: " << dijet_minDRJetPho_ << " dijet_dy_: " << dijet_dy_ << " dijet_leady_: " << dijet_leady_ << " dijet_subleady_: " << dijet_subleady_ << endl;
                */
