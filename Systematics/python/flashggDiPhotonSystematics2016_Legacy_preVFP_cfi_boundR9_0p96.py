...
RVBins = cms.PSet(
    ...
    bins = cms.VPSet(
        cms.PSet(lowBounds = cms.vdouble(0),   upBounds = cms.vdouble(5),  values = cms.vdouble(0.922495, 1.08071), uncertainties = cms.vdouble(0.0120864, 0.0120864, 0.0126329, 0.0126329)),
        cms.PSet(lowBounds = cms.vdouble(5),   upBounds = cms.vdouble(10), values = cms.vdouble(0.948043, 1.06359), uncertainties = cms.vdouble(0.0115661, 0.0115661, 0.0141698, 0.0141698)),
        cms.PSet(lowBounds = cms.vdouble(10),  upBounds = cms.vdouble(15), values = cms.vdouble(0.949742, 1.0761), uncertainties = cms.vdouble(0.0100407, 0.0100407, 0.0152211, 0.0152211)),
        cms.PSet(lowBounds = cms.vdouble(15),  upBounds = cms.vdouble(20), values = cms.vdouble(0.949131, 1.09697), uncertainties = cms.vdouble(0.00761404, 0.00761404, 0.0145522, 0.0145522)),
        cms.PSet(lowBounds = cms.vdouble(20),  upBounds = cms.vdouble(30), values = cms.vdouble(0.962191, 1.10535), uncertainties = cms.vdouble(0.00560365, 0.00560365, 0.0156464, 0.0156464)),
        cms.PSet(lowBounds = cms.vdouble(30),  upBounds = cms.vdouble(40), values = cms.vdouble(0.97824, 1.09835), uncertainties = cms.vdouble(0.00380604, 0.00380604, 0.0172571, 0.0172571)),
        cms.PSet(lowBounds = cms.vdouble(40),  upBounds = cms.vdouble(50), values = cms.vdouble(0.988026, 1.07944), uncertainties = cms.vdouble(0.00265583, 0.00265583, 0.0176868, 0.0176868)),
        cms.PSet(lowBounds = cms.vdouble(50),  upBounds = cms.vdouble(60), values = cms.vdouble(0.990282, 1.09085), uncertainties = cms.vdouble(0.00213706, 0.00213706, 0.0201298, 0.0201298)),
        cms.PSet(lowBounds = cms.vdouble(60),  upBounds = cms.vdouble(80), values = cms.vdouble(0.994209, 1.072), uncertainties = cms.vdouble(0.00176543, 0.00176543, 0.0220277, 0.0220277)),
        cms.PSet(lowBounds = cms.vdouble(80),  upBounds = cms.vdouble(100),values = cms.vdouble(0.997486, 1.04941), uncertainties = cms.vdouble(0.00117326, 0.00117326, 0.0231449, 0.0231449)),
        cms.PSet(lowBounds = cms.vdouble(100), upBounds = cms.vdouble(140),values = cms.vdouble(0.998335, 1.05137), uncertainties = cms.vdouble(0.00118876, 0.00118876, 0.0367819, 0.0367819)),
        cms.PSet(lowBounds = cms.vdouble(140), upBounds = cms.vdouble(200),values = cms.vdouble(0.998696, 1.06233), uncertainties = cms.vdouble(0.00110779, 0.00110779, 0.053169, 0.053169)),
        cms.PSet(lowBounds = cms.vdouble(200), upBounds = cms.vdouble(400),values = cms.vdouble(0.999674, 1.02953), uncertainties = cms.vdouble(0.00162321, 0.00162321, 0.147142, 0.147142)),
...
scalesAndSmearingsPrefix = cms.string("EgammaAnalysis/ElectronTools/data/ScalesSmearings/Run2016_2021-07-06_preVFP_stochastic_oldFormat")
