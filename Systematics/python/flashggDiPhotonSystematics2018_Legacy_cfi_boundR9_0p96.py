...
#        )
#    )
# values from 2016 should be conservative enough so there are here
FNUFBins = cms.PSet(
    variables = cms.vstring("abs(superCluster.eta)","full5x5_r9"),
    bins = cms.VPSet(
...
FNUFInnerEB = cms.PSet( PhotonMethodName = cms.string("FlashggPhotonFNUFScaleEGMTool"),
         ...
         LaserResponseFile = cms.FileInPath("flashgg/Systematics/test_data/average_RoverR0_2018.root"),
